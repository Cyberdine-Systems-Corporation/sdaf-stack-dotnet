...
| ADR | Título | Estado |
|-----|--------|--------|
| [0001](0001-fusion-domain-application.md) | Fusión `domain-application` en 0.1.x | Approved |
| [0002](0002-infrastructure-stub.md) | `infrastructure` como agente stub en 0.1.x | Approved |
